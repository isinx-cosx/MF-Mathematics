 # ————————————MF-Mathematics 线性代数工作区 ————————————

# 导入必要库以及自定义组件
import sys
import os
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
from calc.linear_algebra.calc_block import CalcBlock
from PySide6.QtWidgets import *

# 定义 Workspace 类 —— 线性代数工作区 ——
class Workspace(QWidget):
    def __init__(self):
        super().__init__()

        # 初始化标题和描述标签
        title_label = QLabel("线性代数")
        title_label.setObjectName("title_label")
        desc_label = QLabel("包含：矩阵运算、行列式、特征值、向量计算、线性方程组求解等")
